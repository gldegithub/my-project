...
import org.leo.energy.common.convert.ExtendApplicationConversionService;
...
public class ConvertUtil {
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		...
		GenericConversionService conversionService = ExtendApplicationConversionService.getInstance();
