 ...
 */
package org.leo.energy.service.boot.security.aspect;
...
import org.leo.energy.service.boot.security.permission.PermissionFun;
import org.leo.energy.common.utils.ClassUtil;
...
public class AuthAspect implements ApplicationContextAware {
	 ...
	 */
	@Around(
		"@annotation(org.leo.energy.service.boot.security.annotation.PreAuth) || @within(org.leo.energy.service.boot.security.annotation.PreAuth)"
	)
	...
	private StandardEvaluationContext getEvaluationContext(Method method, Object[] args) {
		...
		StandardEvaluationContext context = new StandardEvaluationContext(new PermissionFun());
		// 设置表达式支持spring bean
