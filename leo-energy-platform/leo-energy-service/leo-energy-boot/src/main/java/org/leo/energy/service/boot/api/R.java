...
import org.leo.energy.common.constant.SystemConstant;
import org.leo.energy.common.utils.ObjectUtil;
...
public class R<T> implements Serializable {
    ...
    public static <T> R<T> data(int code, T data, String msg) {
        return new R<>(code, data, data == null ? SystemConstant.DEFAULT_NULL_MESSAGE : msg);
    }
